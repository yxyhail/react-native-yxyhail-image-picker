...
2. Go to `node_modules` ➜ `react-native-syan-image-picker` and add `RNImagePicker.xcodeproj`
3. In XCode, in the project navigator, select your project. Add `libRNImagePicker.a` to your project's `Build Phases` ➜ `Link Binary With Libraries`
