...
export default {
    ...
    showImagePicker(options, callback) {
        ...
        RNImagePicker.showImagePicker(optionObj, callback)
    },
    ...
    openCamera(options, callback) {
        ...
        RNImagePicker.openCamera(optionObj, callback)
    },
    ...
    asyncOpenCamera(options) {
        ...
        return RNImagePicker.asyncOpenCamera(optionObj);
    },
    ...
    openVideoPicker(options, callback) {
        ...
        return RNImagePicker.openVideoPicker(optionObj, callback)
    }
};
